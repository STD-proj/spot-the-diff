...
class FeaturePointsController():
    ...
    def find_feature_points(self, input_img, blur_thresh=3):
        ...
        canny_img = cv2.Canny(grey_img, 128, 128)
        show_img(canny_img, 'canny img')
    ...
    def second_pass_filtering(self, orig_img, bin_img, rects):
        ...
        for index, (xA, yA, xB, yB) in enumerate(rects):
            ...
            # if index > 1: continue # TODO: remove later
            # sums = []
            ...
            save_img(change_img, self._filename, index)


        show_img(orig_img, 'orig')
        return new_rects
    ...
    def run(self):
        ...
        show_img(copy_img, 'feature points')
        ...
        show_img(bin_img, 'segmentation')
        self.draw_rectangles(copy_img3, rects, (0, 0, 255))
        show_img(copy_img3, 'second')
